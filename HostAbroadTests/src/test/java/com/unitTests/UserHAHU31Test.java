...
public class UserHAHU31Test {

	@Test
	public void test() {
		
		UserHA user1, user2;
		user1 = new UserHA("Adri", "Adrian", "adri@gmail.com", 1234, 5.0, "usuario viajero", false, true, null, null, null, null);
		user2 = new UserHA("Jose", "j", "j@a", 5678, 2, "usuario anfitrion", true, false, null, null, null, null);
